      ...
      <div class="row footer-inner">
        <div class="col-sm-2">
          <ul>
            ...
            <li><a href="/product/22">Booklets</a></li>
            <li><a href="/product/11">Brochures</a></li>
        ...
        <div class="col-sm-2">
          <ul>
            <li class="head invisible">.</li>
            <li><a href="../flyers/">Flyers</a></li>
            <li><a href="../labels/">Labels</a></li>
            <li><a href="../pocket-folders/">Pocket Folders</a></li>
            <li><a href="../rack-cards/">Rack Cards</a></li>
            <li><a href="../stickers/">Stickers</a></li>
           <li><a href="../banners-signs/">Banners & Signs</a></li>
        ...
        <div class="col-sm-2">
          <ul>
            ...
            <li><a href="../big-color-posters-2/">Big Color Posters</a></li>
        ...
        <div class="col-sm-2">
          <ul>
          <li class="head">Locations</li>
          <li>
            <h4>Oakland</h4>
            4237 Piedmont Ave<br/>
            Oakland, CA 94611<br>
            510-655-3030
          </li>
